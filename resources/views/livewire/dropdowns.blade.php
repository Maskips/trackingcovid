<div>
    ...
    <!-- @endif -->
     ...
     <div class="form-group row">
            <label for="kota" class="col-md-4 col-form-label text-md-right">Kecamatan</label>
            <div class="col-md-6">
    ...
    <div class="form-group row">
            <label for="kota" class="col-md-4 col-form-label text-md-right">Kelurahan</label>
            <div class="col-md-6">
    ...
    <div class="form-group row">
            <label for="kota" class="col-md-4 col-form-label text-md-right">Rw</label>
            <div class="col-md-6">
