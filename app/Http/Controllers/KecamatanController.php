...
class KecamatanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $kecamatan->save();
        return redirect()->route('kecamatan.index')->with(['message' => 'Data kota Berhasil Dibuat']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $kecamatan->id_kota = $request->id_kota;
        $kecamatan->save();
        return redirect()->route('kecamatan.index')->with(['message' => 'Data kota Berhasil Diedit']);
    }
